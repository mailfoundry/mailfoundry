...
const INVOICES: Record<string, Invoice> = {
  ...
  "INV-0185": {
    ref: "INV-0185",
    conventionSearch: "Exeter",
    dept: "CS",
    invoiceDate: "2026-05-06",
    paymentDueDate: "2026-06-24",
    shippingCost: 94.56, // "DELIVERY 1 PALLET + TAIL LIFT" — shared pallet, attributed to CS
    items: [
      { code: "GLOVES_VINYL_CLEAR_MED",          qty: 8  },
      { code: "GLOVES_VINYL_CLEAR_L",            qty: 10 },
      { code: "GLOVES_VINYL_CLEAR_XL",           qty: 10 },
      { code: "APRONS_FLTPACK_100PK",            qty: 4  },
      { code: "BUCKET_OVAL_MOP_14L_RED",         qty: 4  },
      { code: "BUCKET_PLASTIC_10L_RED",          qty: 8  },
      { code: "BUCKET_PLASTIC_10L_BLUE",         qty: 8  },
      { code: "MOP_STAND_PY(12)_7OZ_RED",        qty: 8  },
      { code: "HNDL_WOODEN",                     qty: 8  },
      { code: "BRUSH_SOFT_28CM + HANDLE_RED",    qty: 20 },
      { code: "DUSTPAN_BRUSH_SET_BLUE",          qty: 40 },
      { code: "LITTER_PICKER_34INCH",            qty: 15 },
      { code: "TOILET_BRUSH_HOLDER_WHITE",       qty: 10 },
      { code: "TRG_COMPLETE_RED",                qty: 20 },
      { code: "TRG_COMPLETE_BLUE",               qty: 20 },
      { code: "CLOTH_OCEAN_RED_50PK",            qty: 25 },
      { code: "CLOTH_OCEAN_BLUE_50PK",           qty: 25 },
      { code: "CLOTH_MFIBRE_BLUE_10PK",          qty: 6  },
      { code: "CENTRE_FEED_ST_BLUE_6PK",         qty: 8  },
      { code: "REFUSE_SACK_BLACK_100PK",         qty: 2  },
      { code: 'JUG_FUNNEL_6"',                   qty: 1  },
      { code: "JUG_MEASURING_1LITRE",            qty: 1  },
      { code: "IMPACT_LIQUIDS_MULTI_PURPOSE_5L", qty: 2  },
      { code: "CLOVER_ULTRAFRESH_5L",            qty: 3  },
      { code: "PUMP_30CC_FOR_5L",                qty: 2  },
      { code: "BIO_HAZARD_KITS",                 qty: 4  },
      { code: "SHARPS_CONTAINER_1L",             qty: 1  },
    ],
  },
  ...
  "INV-0185-FA": {
    ...
    invoiceDate: "2026-05-06",
    paymentDueDate: "2026-06-24",
    shippingCost: 0, // shared pallet attributed to CS
    items: [
      { code: "FIRSTAID_KIT_MEDIUM_126P",              qty: 1,  unitCost: 32.59 },
      { code: "100PACK_ASSORTED_WATERPROOF_PLASTERS",  qty: 2,  unitCost: 4.79  },
      { code: "EAB_INJURY_BANDAGE_5CMX4.5M",          qty: 5,  unitCost: 2.29  },
      { code: "ECB_BANDAGE_5CMX4M",                   qty: 10, unitCost: 0.49  },
      { code: "MEDIPAL_AW_150P",                      qty: 1                   },
      { code: "SCISSORS_SUPERSNIP_SS",                qty: 5,  unitCost: 0.89  },
      { code: "EYEWASH_INCCAP_500ML",                 qty: 1                   },
      { code: "HI_VIS_YELLOW_M_FA",                   qty: 6,  unitCost: 7.29  },
      { code: "HI_VIS_YELLOW_L_FA",                   qty: 6,  unitCost: 7.29  },
      { code: "HI_VIS_YELLOW_XL_FA",                  qty: 4,  unitCost: 7.29  },
      { code: "HI_VIS_YELLOW_XXL_FA",                 qty: 4,  unitCost: 7.29  },
      { code: "GLOVES_NITRILE_BLUE_MED",              qty: 1                   },
      { code: "GLOVES_NITRILE_BLUE_L",                qty: 1                   },
      { code: "GLOVES_NITRILE_BLUE_XL",               qty: 1                   },
      { code: "APRONS_FLTPACK_100PK",                 qty: 1                   },
      { code: "VOMIT_BAGS_50PACK",                    qty: 1,  unitCost: 14.29 },
      { code: "TISSUE_FACIAL_100SHEETS",              qty: 3,  unitCost: 0.79  },
      { code: "CENTRE_FEED_ST_BLUE_6PK",              qty: 1                   },
      { code: "DISP_PILLOW_50PACK",                   qty: 1,  unitCost: 22.89 },
      { code: "COUCH_ROLL_50CMX50M",                  qty: 2,  unitCost: 12.59 },
    ],
  },
  ...
  "INV-0186": {
    ...
    shippingCost: 152.12, // "DELIVERY 2 PALLETS + TAIL LIFT" × 2 @ £76.06
    items: [
      { code: "HI_VIS_BLUE_L",                                              qty: 5   },
      { code: "HI_VIS_BLUE_XL",                                             qty: 5   },
      { code: "GLOVES_VINYL_CLEAR_SML",                                     qty: 40  },
      { code: "GLOVES_VINYL_CLEAR_MED",                                     qty: 25  },
      { code: "GLOVES_VINYL_CLEAR_L",                                       qty: 30  },
      { code: "GLOVES_VINYL_CLEAR_XL",                                      qty: 20  },
      { code: "APRONS_FLTPACK_100PK",                                       qty: 10  },
      { code: "HANDLE HYGIENE 125CM - BLUE",                                qty: 20  },
      { code: "HANDLE HYGIENE 125CM - RED",                                 qty: 10  },
      { code: "KTY MOP HYGIEMIX S/BACK COL S/FLAT 450G PB (10 PACK) - BLUE", qty: 1 },
      { code: "KTY MOP HYGIEMIX S/BACK COL S/FLAT 450G PB (10 PACK) - RED",  qty: 1 },
      { code: "SKT MOP HYGIEMIX T1D 200G - BLUE",                          qty: 200 },
      { code: "SKT MOP HYGIEMIX T1D 200G - RED",                           qty: 100 },
      { code: "BRUSH_SOFT_28CM + HANDLE_RED",                               qty: 30  },
      { code: "BRUSH_SOFT_28CM + HANDLE_BLUE",                              qty: 120 },
      { code: "DUSTPAN_BRUSH_SET_RED",                                      qty: 5   },
      { code: "DUSTPAN_BRUSH_SET_BLUE",                                     qty: 15  },
      { code: "WET_FLOOR_AFRAME",                                           qty: 5   },
      { code: "TOILET_BRUSH_HOLDER_WHITE",                                  qty: 40  },
      { code: "CLOTH_OCEAN_RED_50PK",                                       qty: 40  },
      { code: "CLOTH_OCEAN_BLUE_50PK",                                      qty: 50  },
      { code: "CLOTH_MFIBRE_BLUE_10PK",                                     qty: 10  },
      { code: "CLOTH_MFIBRE_PINK_10PK",                                     qty: 6   },
      { code: "REFUSE_SACK_CLEAR_100PK",                                    qty: 3   },
      { code: "SHARPS_CONTAINER_7L",                                        qty: 2   },
      { code: "CLOVER_ULTRAFRESH_5L",                                       qty: 1   },
      { code: "PUMP_30CC_FOR_5L",                                           qty: 3   },
    ],
  },
