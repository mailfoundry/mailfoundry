    ...
    <section className="flex-1 px-6 py-20">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">2. Trade Accounts &amp; Orders</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">3. Payment</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">4. Delivery</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">5. Returns &amp; Faulty Goods</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">6. Liability</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">7. Governing Law</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">8. Contact</h2>
            <p>
        ...
        <p className="mt-16 text-xs text-gray-400 border-t border-gray-200 pt-6">
