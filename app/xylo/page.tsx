    ...
    <>
      ...
      <section className="flex-1 flex items-center justify-center px-6 py-24">
        <div className="max-w-2xl w-full text-center">
          ...
          {/* Description */}
          <p className="text-lg leading-relaxed text-gray-300 max-w-lg mx-auto mb-12">
          ...
          <div className="grid grid-cols-2 gap-4 max-w-md mx-auto mb-12">
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 text-left">
              ...
              <p className="font-bold text-sm text-gray-900 mb-1">Cleaning Supplies</p>
              <p className="text-xs text-gray-300 leading-relaxed">PPE, janitorial &amp; hygiene products</p>
            </div>
            <div className="rounded-xl border border-gray-200 bg-gray-50 p-5 text-left">
              <div className="w-9 h-9 rounded-lg bg-orange-500/10 flex items-center justify-center mb-3">
                <svg className="w-5 h-5 text-orange-400" fill="none" stroke="currentColor" strokeWidth={1.5} viewBox="0 0 24 24">
              ...
              <p className="font-bold text-sm text-gray-900 mb-1">First Aid</p>
              <p className="text-xs text-gray-300 leading-relaxed">Kits, consumables &amp; safety equipment</p>
            </div>
          </div>
          ...
          <a
            href="/contact"
            className="inline-block bg-orange-500 hover:bg-orange-400 text-gray-900 font-bold text-sm px-8 py-3.5 rounded-xl transition-colors tracking-wide"
          >
            General Enquiries →
          </a>
          <p className="mt-3 text-xs text-gray-400">hello@xylouk.co.uk &nbsp;·&nbsp; 07714 747777</p>

        </div>
      </section>

      {/* Trust strip */}
      <section className="border-t border-gray-200 px-6 py-12 bg-gray-50">
