    ...
    <section className="flex-1 px-6 py-20">
      <div className="max-w-2xl mx-auto">
        ...
        <div className="space-y-8 text-sm text-gray-600 leading-relaxed">
          <div>
            <h2 className="text-gray-900 font-bold mb-2">1. Who We Are</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">2. What We Collect</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">3. How We Use It</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">4. Retention</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">5. Your Rights</h2>
            <p>
          ...
          <div>
            <h2 className="text-gray-900 font-bold mb-2">6. Contact</h2>
            <p>
