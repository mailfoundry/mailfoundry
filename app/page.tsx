  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      ...
      <section className="mx-auto max-w-4xl px-8 pb-24 pt-20 text-center">
        <div className="mb-6 inline-block rounded-full border border-orange-300 bg-orange-50 px-4 py-1.5 text-sm font-medium text-orange-600">
        ...
        <h1 className="text-5xl font-bold leading-tight tracking-tight sm:text-6xl">
          Supplies for every
          <br />
          <span className="text-orange-500">convention &amp; assembly</span>
        </h1>
        ...
        <div className="mx-auto max-w-5xl px-8 py-20">
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mb-2 text-lg font-semibold text-gray-900">Simple online ordering</h3>
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mb-2 text-lg font-semibold text-gray-900">Full product range</h3>
              <p className="text-sm text-gray-500">
            ...
            <div className="rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
              ...
              <h3 className="mb-2 text-lg font-semibold text-gray-900">Direct fulfilment</h3>
              <p className="text-sm text-gray-500">
      ...
      <section className="mx-auto max-w-3xl px-8 py-20 text-center">
        <h2 className="text-3xl font-bold text-gray-900">Ready to place an order?</h2>
