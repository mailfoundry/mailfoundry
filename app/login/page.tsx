...
export default async function LoginPage({ searchParams }: LoginPageProps) {
  ...
  return (
    <main className="flex min-h-screen bg-gray-50 text-gray-900">
      {/* Left panel — branding */}
      <div className="hidden flex-col justify-between p-12 lg:flex lg:w-1/2 border-r border-gray-200">
        <div>
          <Logo height={44} />
        </div>
        ...
        <div>
          <h1 className="text-4xl font-bold leading-tight text-gray-900">
            ...
            <br />
            <span className="text-orange-500">supply ordering</span>
          </h1>
          ...
          <ul className="mt-10 space-y-4">
            {[
              ...
              <li key={item} className="flex items-center gap-3 text-sm text-gray-600">
                <span className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-orange-100 text-orange-500">
        ...
        <p className="text-sm text-gray-400">
          © {new Date().getFullYear()} Xylo (UK) Ltd · <a href="https://www.xylouk.co.uk" className="hover:text-gray-600 transition-colors">xylouk.co.uk</a>
        </p>
      </div>
